...
# (1)
setwd('conResults/conRData/3model/1row')
conSIMULATE(180, 99, 10, 3, 1, bv3, c(0.03, 0.015, 0.2), 3) # N=180, I=99

# (2)
setwd('../2row')
conSIMULATE(240, 132, 10, 3, 1, bv3, c(0.1, 0.05, 0.2), 3) # N=240, I=132

# (3)
setwd('../3row')
conSIMULATE(200, 110, 10, 3, 1, bv3, c(0.01, 0.005, 0.4), 3) # N=200, I=110

# (4)
setwd('../4row')
conSIMULATE(160, 88, 10, 4, 1, bv4, c(0.03, 0.015, 0.2), 3) # N=160, I=88

# (5)
setwd('../5row')
conSIMULATE(220, 121, 10, 4, 1, bv4, c(0.1, 0.05, 0.2), 3) # N=220, I=121

# (6)
setwd('../6row')
conSIMULATE(180, 99, 10, 4, 1, bv4, c(0.01, 0.005, 0.4), 3) # N=180, I=99
