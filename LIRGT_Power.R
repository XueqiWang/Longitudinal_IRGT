########################################################################################################################
# Function of power calculations for longitudinal IRGT trials with a continuous or binary outcome
...
lirgt_power <- function(I, Kt, Kc, t, family="gaussian", link=NULL, model = "NT-CTE", b, phit=1, phic=1, alpha, rho, qc=1/2, size=0.05){
...
# NT-CTE model
b <- 0.35; I <- 99
lirgt_power(I=I, Kt, Kc, t, family="gaussian", link=NULL, model="NT-CTE", b=b, phit=1, phic=1, alpha, rho, qc=qc, size=0.05)

# LT-CTE model
b <- 0.35; I <- 99
lirgt_power(I=I, Kt, Kc, t, family="gaussian", link=NULL, model="LT-CTE", b=b, phit=1, phic=1, alpha, rho, qc=qc, size=0.05)

# CT-CTE model
b <- 0.35; I <- 99
lirgt_power(I=I, Kt, Kc, t, family="gaussian", link=NULL, model="CT-CTE", b=b, phit=1, phic=1, alpha, rho, qc=qc, size=0.05)

# LT-TI model
b <- c(0.18, 0.1); I <- 99
lirgt_power(I=I, Kt, Kc, t, family="gaussian", link=NULL, model="LT-TI", b=b, phit=1, phic=1, alpha, rho, qc=qc, size=0.05)

# CT-TI model
b <- cumsum(0.3*c(0.6^1, 0.6^2, 0.6^3)); I <- 187
lirgt_power(I=I, Kt, Kc, t, family="gaussian", link=NULL, model="CT-TI", b=b, phit=1, phic=1, alpha, rho, qc=qc, size=0.05)
...
# NT-CTE model
b <- c(0, log(2)); I <- 110
lirgt_power(I=I, Kt, Kc, t, family="binomial", link=NULL, model="NT-CTE", b=b, phit=1, phic=1, alpha, rho, qc=qc, size=0.05)

# LT-CTE model
b <- c(log(0.7), log(1.2), log(1.9)); I <- 121
lirgt_power(I=I, Kt, Kc, t, family="binomial", link=NULL, model="LT-CTE", b=b, phit=1, phic=1, alpha, rho, qc=qc, size=0.05)

# CT-CTE model
b <- c(cumsum(0.1*c(0.5^1, 0.5^2, 0.5^3)), log(2)); I <- 110
lirgt_power(I=I, Kt, Kc, t, family="binomial", link=NULL, model="CT-CTE", b=b, phit=1, phic=1, alpha, rho, qc=qc, size=0.05)

# LT-TI model
b <- c(log(0.2), log(1.005), log(1.1), log(1.4)); I <- 110
lirgt_power(I=I, Kt, Kc, t, family="binomial", link=NULL, model="LT-TI", b=b, phit=1, phic=1, alpha, rho, qc=qc, size=0.05)

# CT-TI model
b <- c(cumsum(0.1*c(0.5^1, 0.5^2, 0.5^3)), cumsum(0.65*c(0.6^1, 0.6^2, 0.6^3))); I <- 176
lirgt_power(I=I, Kt, Kc, t, family="binomial", link=NULL, model="CT-TI", b=b, phit=1, phic=1, alpha, rho, qc=qc, size=0.05)
