...
# (1)
setwd('binResults/binRData/3model/1row')
binSIMULATE(200, 110, 10, 3, beta3, c(0.03, 0.015, 0.2), 3) # N=200, I=110

# (2)
setwd('../2row')
binSIMULATE(260, 143, 10, 3, beta3, c(0.1, 0.05, 0.2), 3) # N=260, I=143

# (3)
setwd('../3row')
binSIMULATE(220, 121, 10, 3, beta3, c(0.01, 0.005, 0.4), 3) # N=220, I=121

# (4)
setwd('../4row')
binSIMULATE(180, 99, 10, 4, beta4, c(0.03, 0.015, 0.2), 3) # N=180, I=99

# (5)
setwd('../5row')
binSIMULATE(240, 132, 10, 4, beta4, c(0.1, 0.05, 0.2), 3) # N=240, I=132

# (6)
setwd('../6row')
binSIMULATE(200, 110, 10, 4, beta4, c(0.01, 0.005, 0.4), 3) # N=200, I=110
