...
b1j_in <- c(0.5^1, 0.5^2, 0.5^3, 0.5^4)
b1j <- cumsum(b1j_in)
b2j_in <- 0.3*c(0.6^1, 0.6^2, 0.6^3, 0.6^4)
b2j <- cumsum(b2j_in)

# (1)
setwd('conResults/conRData/5model/1row')
conSIMULATE(340, 187, 10, 3, 1, c(b1j[1:3], b2j[1:3]), c(0.03, 0.015, 0.2), 5) # N=340, I=187

# (2)
setwd('../2row')
conSIMULATE(460, 253, 10, 3, 1, c(b1j[1:3], b2j[1:3]), c(0.1, 0.05, 0.2), 5) # N=460, I=253

# (3)
setwd('../3row')
conSIMULATE(360, 198, 10, 3, 1, c(b1j[1:3], b2j[1:3]), c(0.01, 0.005, 0.4), 5) # N=360, I=198

# (4)
setwd('../4row')
conSIMULATE(260, 143, 10, 4, 1, c(b1j, b2j), c(0.03, 0.015, 0.2), 5) # N=260, I=143

# (5)
setwd('../5row')
conSIMULATE(360, 198, 10, 4, 1, c(b1j, b2j), c(0.1, 0.05, 0.2), 5) # N=360, I=198

# (6)
setwd('../6row')
conSIMULATE(280, 154, 10, 4, 1, c(b1j, b2j), c(0.01, 0.005, 0.4), 5) # N=280, I=154
