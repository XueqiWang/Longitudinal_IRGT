...
binMAEE=function(y, X, id, n, Z, maxiter, epsilon, 
  ...
  RESULTS=function(beta, alpha, robust, naive, varMD, varKC, varFG, varMBN, niter, n){
    ...
    outbVAR=naive
    outbVARBC0=robust[1:p,1:p]
    outbVARBC1=varKC[1:p,1:p]
    outbVARBC2=varMD[1:p,1:p]
    outbVARBC3=varFG[1:p,1:p]
    outbVARBC4=varMBN[1:p,1:p]
    ...
    #print(outalpha)
    #cat("\n")
    return(list(outbeta=outbeta[,-1],outbVAR=outbVAR,outbVARBC0=outbVARBC0,
                outbVARBC1=outbVARBC1,outbVARBC2=outbVARBC2,outbVARBC3=outbVARBC3,outbVARBC4=outbVARBC4,
                outalpha=outalpha[,-1]))
  }
