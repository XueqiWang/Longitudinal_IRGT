...
# (1)
setwd('binResults/binRData/1model/1row')
binSIMULATE(200, 110, 10, 3, beta, c(0.03, 0.015, 0.2), 1) # N=200, I=110

# (2)
setwd('../2row')
binSIMULATE(260, 143, 10, 3, beta, c(0.1, 0.05, 0.2), 1) # N=260, I=143

# (3)
setwd('../3row')
binSIMULATE(220, 121, 10, 3, beta, c(0.01, 0.005, 0.4), 1) # N=220, I=121

# (4)
setwd('../4row')
binSIMULATE(160, 88, 10, 4, beta, c(0.03, 0.015, 0.2), 1) # N=160, I=88

# (5)
setwd('../5row')
binSIMULATE(240, 132, 10, 4, beta, c(0.1, 0.05, 0.2), 1) # N=240, I=132

# (6)
setwd('../6row')
binSIMULATE(200, 110, 10, 4, beta, c(0.01, 0.005, 0.4), 1) # N=200, I=110
